...
from model.main.traditional_rnn import Gru1HL
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import gru1hl_paras_final as param_grid
...
if test_type == "normal":  ### For normal test
    ...
    all_model_file_name = "stability_gru1hl"
else:
    pass
    ...
    for _ in range(run_times):
        for loop in range(len(rv_data)):
            ...
            for item in list(ParameterGrid(param_grid)):
                ...
                print("running gru with data {} and time {}".format(loop, time.total_seconds()))
