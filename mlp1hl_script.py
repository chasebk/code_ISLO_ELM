...
from model.main.traditional_ffnn import FFNN1HL
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import ffnn1hl_paras_final as param_grid
...
if test_type == "normal":           ### For normal test
    ...
    all_model_file_name = "stability_mlp1hl"
else:
    pass
...
def train_model(item, dataset, requirement_variables):
    ...
    md = FFNN1HL(root_base_paras=root_base_paras, root_mlnn_paras=root_mlnn_paras)
    md._running__()
    ...
    for _ in range(run_times):
        for loop in range(len(rv_data)):
            ...
            for item in list(ParameterGrid(param_grid)):
                ...
                print("running mlp with data {} and time {}".format(loop, time.total_seconds()))